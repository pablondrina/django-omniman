"""
SMS Backend — Template para integração com SMS.
...
class TwilioSMSBackend:
    ...
    Args:
        ...
        from_number: Número de origem (formato E.164: +15551234567)
    ...
    Configuração via settings:
        OMNIMAN_NOTIFICATIONS = {
            "backends": {
                "sms": {
                    "class": "omniman.contrib.notifications.backends.TwilioSMSBackend",
    ...
    def _build_message(self, event: str, context: dict[str, Any]) -> str:
        ...
        Override este método para customizar as mensagens.
        """
        ...
        # Fallback genérico
        return f"Omniman: {event} - {context.get('order_ref', 'N/A')}"
