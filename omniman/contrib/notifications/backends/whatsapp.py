"""
WhatsApp Backend — Template para integração com WhatsApp.

Este é um TEMPLATE. Você deve configurar com seu provider:
...
Adapte para seu provider específico.
"""
...
class WhatsAppBackend:
    ...
    Args:
        ...
        api_version: Versão da API (default: v17.0)
    ...
    def send(
        ...
        *,
        event: str,
        recipient: str,  # Número no formato +5511999999999
        context: dict[str, Any],
    ) -> NotificationResult:
        """
        Envia mensagem via WhatsApp.

        O 'event' é mapeado para um template aprovado no Meta.
        """
    ...
    def _get_template_name(self, event: str) -> str:
        ...
        Override este método para customizar o mapeamento.
        """
    ...
    def _build_components(self, context: dict[str, Any]) -> list[dict]:
        ...
        Override este método para customizar os parâmetros.
        """
        # Extrai variáveis comuns
        params = []
