...
Este é o backend mais importante: conecta com qualquer serviço externo
(Zapier, n8n, Make, seu próprio servidor, etc).

A partir do webhook você pode rotear para WhatsApp, SMS, Telegram, etc.
"""
...
class WebhookBackend:
    """
    Backend que envia notificações via HTTP POST.

    Conecta com qualquer serviço externo:
    - Zapier, n8n, Make (automação)
    - Seu próprio microserviço
