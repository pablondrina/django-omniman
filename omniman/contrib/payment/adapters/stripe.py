...
from omniman.contrib.payment.protocols import (
    CaptureResult,
    PaymentIntent,
    PaymentStatus,
    RefundResult,
...
class StripeBackend:
    ...
    def create_intent(
        ...
        *,
        ...
        meta = metadata or {}
        if reference:
            meta["omniman_reference"] = reference
        ...
        *,
        ...
        try:
            ...
            if reason:
                ...
                params["metadata"] = {"omniman_reason": reason}
    ...
    def _map_status(self, stripe_status: str) -> str:
        """Mapeia status Stripe para status Omniman."""
        mapping = {
