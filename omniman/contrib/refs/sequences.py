...
from omniman.contrib.refs.registry import get_ref_type
from omniman.contrib.refs.exceptions import RefTypeNotFound, RefScopeInvalid
...
def attach_sequence_ref(
    ...
    """
    from omniman.contrib.refs.services import attach_ref
