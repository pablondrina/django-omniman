...
class ChannelSerializer(serializers.ModelSerializer):
    class Meta:
        model = Channel
        fields = ("id", "code", "name", "pricing_policy", "edit_policy", "display_order", "config", "is_active")
...
class SessionCreateSerializer(serializers.Serializer):
    ...
    Notas:
    - `channel_code` usa SlugRelatedField para renderizar <select> na Browsable API.
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Order
        fields = ("id", "ref", "channel", "channel_code", "status", "created_at")
