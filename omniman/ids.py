...
def _generate_id(prefix: str, length: int = 8) -> str:
    ...
    Args:
        prefix: Prefixo do ID (ex.: "ORD", "SESS", "L")
        length: Comprimento da parte aleatória

    Returns:
        ID no formato PREFIX-XXXXXXXX
    """
...
def generate_order_ref() -> str:
    ...
    Returns:
        Referência única com data local timezone-aware
    """
...
def generate_session_key() -> str:
    """
    Gera chave única para Session.

    Formato: SESS-XXXXXXXX
    """
...
def generate_line_id() -> str:
    """
    Gera ID único para linha de item.
...
def generate_action_id() -> str:
    """
    Gera ID único para Action.

    Formato: ACT-XXXXXXXX
    """
