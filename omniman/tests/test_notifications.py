...
from omniman.contrib.notifications.backends.console import ConsoleBackend
from omniman.contrib.notifications.backends.email import EmailBackend
from omniman.contrib.notifications.backends.sms import TwilioSMSBackend
from omniman.contrib.notifications.backends.webhook import WebhookBackend
from omniman.contrib.notifications.backends.whatsapp import WhatsAppBackend
from omniman.contrib.notifications.protocols import NotificationResult
from omniman.contrib.notifications import service
...
class NotificationServiceTests(TestCase):
    ...
    @override_settings(OMNIMAN_NOTIFICATIONS={"default_backend": "console"})
    ...
    @override_settings(OMNIMAN_NOTIFICATIONS={})
...
class ConsoleBackendTests(TestCase):
    ...
    def test_send_logs_notification(self) -> None:
        ...
        with patch(
            "omniman.contrib.notifications.backends.console.logger"
        ) as mock_logger:
            backend.send(
                event="order.shipped",
...
class WebhookBackendTests(TestCase):
    ...
    @patch("omniman.contrib.notifications.backends.webhook.urlopen")
...
class EmailBackendTests(TestCase):
    ...
    @patch("omniman.contrib.notifications.backends.email.send_mail")
...
class TwilioSMSBackendTests(TestCase):
    ...
    @patch("omniman.contrib.notifications.backends.sms.urlopen")
    def test_send_success(self, mock_urlopen) -> None:
...
class WhatsAppBackendTests(TestCase):
    ...
    @patch("omniman.contrib.notifications.backends.whatsapp.urlopen")
    def test_send_success(self, mock_urlopen) -> None:
